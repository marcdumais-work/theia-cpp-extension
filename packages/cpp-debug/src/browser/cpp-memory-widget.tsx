 ...
 */
class ForwardIterator implements Iterator<IndexAndByte> {
...
class ReverseIterator implements Iterator<IndexAndByte> {
...
export class MemoryView extends ReactWidget {
    ...
    protected renderViewRows(result: MemoryReadResult, variables: VariableRange[]): React.ReactNode {
        ...
        let byteAddress = result.address.add(0);
